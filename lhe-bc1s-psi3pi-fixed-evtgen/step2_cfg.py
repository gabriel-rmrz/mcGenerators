...
# with command line options: step2 --filein file:step1.root --fileout file:step2.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 4 --geometry DB:Extended --era Run2_2018 --python_filename step2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
